...
namespace GamePedia
{
    ...
    /// </summary>
    public sealed partial class SearchPage : GamePedia.Common.LayoutAwarePage
    {
        ...
        protected override void LoadState(Object navigationParameter, Dictionary<String, Object> pageState)
        {
            ...
            var groups = GamePediaDataSource.GetGroups("AllGroups");
            string query = queryText.ToLower();
            var all = new List<GamePediaDataItem>();
